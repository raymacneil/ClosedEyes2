...
RED = (1,-1,-1)
GRN = (-1,1,-1)
### Create arrays for small medium and large angles
i = randrange(0,1)
angles_horz = np.array([[5.25,11.25,17.25],[5.25,8.25,14.25],[5.25,8.25,14.25],[5.25,11.25,14.25],[5.25,8.25,17.25]])
angles_vert = np.array([[1.00,5.50,10.00],[1.00,3.25,7.75],[1.00,3.25,7.75],[1.00,5.50,7.75],[1.00,3.25,10.00]])
...
if not exp_abort :
    ...
    if run_calib_trials :
        ...
        exp_abort = ss_runcalibs(w, calOrderID[0], FG_COLOUR, BG_COLOUR, RED, GRN, PPCM, st_cal_msg1, end_cal_msg1, caliOrderHorz, numCalibTargets, numTrialsPerTarget_HorzCalib, isi, angles_horz, angles_vert, fix_shift, ev_outlet, eog_conn, el_outlet, elTk, EYE_TO_SCREEN_CM)
    ...
    if not exp_abort:
        ...
        if cond != 4 :
            ...
            if cond == 1:
                ss_runtrials(w, FG_COLOUR, BG_COLOUR, RED, GRN, PPCM, st_exp_msg, end_cond_msg1, trialTargetOrder[0][0:], trialBlockNumber[0][0:], blockNumbers[0][0:], blockMarkersOn[0][0:], blockTargDir[0][0:], isi, angles_horz, angles_vert, fix_shift, ev_outlet, eog_conn, el_outlet, elTk, EYE_TO_SCREEN_CM)           
            elif cond == 2:
                ss_runtrials_cond2(w, FG_COLOUR, BG_COLOUR, RED, GRN, PPCM, st_exp_msg, end_cond_msg1, trialTargetOrder[0][0:], trialBlockNumber[0][0:], blockNumbers[0][0:], blockEyesOpen[0][0:], isi, angles_horz, angles_vert, fix_shift, ev_outlet, eog_conn, el_outlet, elTk)
    ...
    if not exp_abort:
        ...
        if cond != 4 :
            ...
            if cond == 1:
                ss_runtrials(w, FG_COLOUR, BG_COLOUR, RED, GRN, PPCM, st_exp_msg, end_cond_msg2, trialTargetOrder[1][0:], trialBlockNumber[1][0:], blockNumbers[1][0:], blockMarkersOn[1][0:], blockTargDir[1][0:], isi, angles_horz, angles_vert, fix_shift, ev_outlet, eog_conn, el_outlet, elTk, EYE_TO_SCREEN_CM)           
            elif cond == 2:
    ...
    if not exp_abort:
        ...
        if cond != 4 :
            ...
            if cond == 1:
                ss_runtrials(w, FG_COLOUR, BG_COLOUR, RED, GRN, PPCM, st_exp_msg, end_cond_msg3, trialTargetOrder[2][0:], trialBlockNumber[2][0:], blockNumbers[2][0:], blockMarkersOn[2][0:], blockTargDir[2][0:], isi, angles_horz, angles_vert, fix_shift, ev_outlet, eog_conn, el_outlet, elTk, EYE_TO_SCREEN_CM)           
            elif cond == 2:
